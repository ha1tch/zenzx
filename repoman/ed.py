#!/usr/bin/env python3
"""Thin shim -- forwards to the gorepoman binary's `ed` subcommand.
...
`python3 repoman/ed.py ...` (Makefile targets, .repoman.json
...
def main():
    ...
    if binary is None:
        sys.stderr.write(
            "error: gorepoman binary not found for repoman/ed.py shim.\n"
