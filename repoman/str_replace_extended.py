#!/usr/bin/env python3
"""Thin shim -- forwards to the gorepoman binary's `strreplace` subcommand.
...
`python3 repoman/str_replace_extended.py ...` (Makefile targets, .repoman.json
...
def main():
    ...
    if binary is None:
        sys.stderr.write(
            "error: gorepoman binary not found for repoman/str_replace_extended.py shim.\n"
