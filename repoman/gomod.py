#!/usr/bin/env python3
"""Thin shim -- forwards to the gorepoman binary's `gomod` subcommand.
...
`python3 repoman/gomod.py ...` (Makefile targets, .repoman.json
...
def main():
    ...
    if binary is None:
        sys.stderr.write(
            "error: gorepoman binary not found for repoman/gomod.py shim.\n"
