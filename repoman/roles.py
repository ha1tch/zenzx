#!/usr/bin/env python3
"""Thin shim -- forwards to the gorepoman binary's `roles` subcommand.
...
`python3 repoman/roles.py ...` (Makefile targets, .repoman.json
...
def main():
    ...
    if binary is None:
        sys.stderr.write(
            "error: gorepoman binary not found for repoman/roles.py shim.\n"
