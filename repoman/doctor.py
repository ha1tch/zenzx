#!/usr/bin/env python3
"""Thin shim -- forwards to the gorepoman binary's `doctor` subcommand.
...
`python3 repoman/doctor.py ...` (Makefile targets, .repoman.json
...
def main():
    ...
    if binary is None:
        sys.stderr.write(
            "error: gorepoman binary not found for repoman/doctor.py shim.\n"
