#!/usr/bin/env python3
"""Thin shim -- forwards to the gorepoman binary's `relcore` subcommand.
...
`python3 repoman/relcore.py ...` (Makefile targets, .repoman.json
...
def main():
    ...
    if binary is None:
        sys.stderr.write(
            "error: gorepoman binary not found for repoman/relcore.py shim.\n"
