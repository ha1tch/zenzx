#!/usr/bin/env python3
"""Thin shim -- forwards to the gorepoman binary's `addwave` subcommand.
...
`python3 repoman/add_wave.py ...` (Makefile targets, .repoman.json
...
def main():
    ...
    if binary is None:
        sys.stderr.write(
            "error: gorepoman binary not found for repoman/add_wave.py shim.\n"
