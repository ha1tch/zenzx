#!/usr/bin/env python3
"""Thin shim -- forwards to the gorepoman binary's `waveprogress` subcommand.
...
`python3 repoman/wave_progress.py ...` (Makefile targets, .repoman.json
...
def main():
    ...
    if binary is None:
        sys.stderr.write(
            "error: gorepoman binary not found for repoman/wave_progress.py shim.\n"
