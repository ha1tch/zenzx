#!/usr/bin/env python3
"""Thin shim -- forwards to the gorepoman binary's `selftest` subcommand.
...
`python3 repoman/selftest.py ...` (Makefile targets, .repoman.json
...
def main():
    ...
    if binary is None:
        sys.stderr.write(
            "error: gorepoman binary not found for repoman/selftest.py shim.\n"
